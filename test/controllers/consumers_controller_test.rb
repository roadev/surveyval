...
class ConsumersControllerTest < ActionController::TestCase
  ...
  test "should create consumer" do
    assert_difference('Consumer.count') do
      post :create, consumer: { clave: @consumer.clave, consumer_id: @consumer.consumer_id, email: @consumer.email, ip_address: @consumer.ip_address }
    end
  ...
  test "should update consumer" do
    patch :update, id: @consumer, consumer: { clave: @consumer.clave, consumer_id: @consumer.consumer_id, email: @consumer.email, ip_address: @consumer.ip_address }
    assert_redirected_to consumer_path(assigns(:consumer))
  end
